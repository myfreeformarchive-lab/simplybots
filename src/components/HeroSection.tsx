    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-28 md:pt-20 pb-32">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card text-sm font-medium mb-8 border border-white/10"
        >
          ...
          Interconnected Telegram Bots for Token Projects
        </motion.div>
