    ...
    <main className="min-h-screen bg-black text-white selection:bg-solana-purple/30 selection:text-white">
      ...
      <section className="relative">
        <div className="w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 divide-y divide-white/10 lg:divide-y-0 lg:divide-x lg:min-h-[calc(100vh-4rem)] lg:min-h-[calc(100dvh-4rem)] lg:h-[calc(100vh-4rem)] lg:h-[calc(100dvh-4rem)]">
          ...
          <div className="flex flex-col items-center text-center gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white/[0.025] lg:bg-white/5 hover:bg-white/10 transition-colors font-bold"
              >
